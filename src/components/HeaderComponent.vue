    ...
    <div class="center">
      ...
      <nav id="menu">
        <ul>
          ...
          <li>
            <!-- Enviar parametros desde enlaces en este caso el parametro id -->
            <router-link :to="{name:'pagina',params:{id:'Parametroid'}}" active-class="active">Pagina 1</router-link>
          </li>
          <li>
            <router-link to="/pelicula" active-class="active">Pelicula</router-link>
          </li>
        </ul>
      </nav>
